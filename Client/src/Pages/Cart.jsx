...
//   const totalPrice = item?.reduce((acc, p) => acc + p.price, 0) || 0;
...
//     return <p className="text-center text-muted mt-5">No Carts to Find!!!!.....</p>;

//   return (
//     <div className="container mt-5">
//       <h2 className="mb-4 text-center "><i class="bi bi-cart-fill"></i> Your Cart</h2>
